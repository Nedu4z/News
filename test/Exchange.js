...
describe('Exchange', () => {
    ...
    beforeEach(async () => {
        ...
        token1 = await Token.deploy('Dapp', 'DAPPS', '1000000')
        token2 = await Token.deploy('MOC Dai', 'mDAI', '1000000')
    ...
    describe('Order actions', async () => {
        ...
        describe('Filling orders', async () => {
            ...
            describe('Failure', () => {
                it('Rejects invalid order ids', async () => {
                    const invalidOrderId = 99999
                    transaction = await expect(exchange.connect(user2).fillOrder(invalidOrderId)).to.be.reverted
                })
